...
N_("America/Creston");
/* comment for time zone America/Creston */
N_("Mountain Standard Time - Creston, British Columbia");
N_("America/Cuiaba");
...
/* comment for time zone America/Metlakatla */
N_("Metlakatla Time - Annette Island");
...
/* comment for time zone America/North_Dakota/Beulah */
N_("Central Time - North Dakota - Mercer County");
...
N_("Central Standard Time - Resolute, Nunavut");
...
N_("America/Sitka");
/* comment for time zone America/Sitka */
N_("Alaska Time - southeast Alaska panhandle");
...
N_("west New Guinea (Irian Jaya) & Malukus (Moluccas)");
N_("Asia/Jerusalem");
N_("Asia/Kabul");
N_("Asia/Kamchatka");
...
N_("east & south Borneo, Sulawesi (Celebes), Bali, Nusa Tengarra, west Timor");
N_("Asia/Manila");
N_("Asia/Muscat");
N_("Asia/Nicosia");
